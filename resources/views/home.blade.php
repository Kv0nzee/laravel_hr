...
<div class="flex items-center justify-center gap-6">
  <div
    class="relative p-5 overflow-hidden transition-all duration-500 transform bg-gray-100 shadow-xl md:w-1/2 dark:bg-gray-800 hover:shadow-2xl group rounded-xl">
