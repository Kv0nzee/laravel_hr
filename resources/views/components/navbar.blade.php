...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full border-r border-gray-200 md:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
   <div class="h-full px-3 pb-4 overflow-y-scroll element-with-scrollbar dark:bg-gray-800">
      <ul class="space-y-2 font-medium ">
         ...
         <li>
            <a href="/company_setting" class="flex items-center px-4 py-2 text-gray-300 {{ request()->is('company_setting*') ? 'bg-gray-600 text-white' : 'hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white' }}">
               <span class="sr-only">Company Setting</span>
               <i class="mr-3 text-lg bi bi-buildings"></i>
               Company Setting
            </a>
         </li>
         @endcan
         @can('view employees')
         <li>
            <a href="/employee" class="flex items-center px-4 py-2 text-gray-300 {{ request()->is('employee*') ? 'bg-gray-600 text-white' : 'hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white' }}">
         ...
         <li>
            <a href="/department" class="flex items-center px-4 py-2 text-gray-300 {{ request()->is('department*') ? 'bg-gray-600 text-white' : 'hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white' }}">
         ...
         @can('view roles')
         <li>
            <a href="/role" class="flex items-center px-4 py-2 text-gray-300 {{ request()->is('role*') ? 'bg-gray-600 text-white' : 'hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white' }}">
         ...
         <li>
            <a href="/permission" class="flex items-center px-4 py-2 text-gray-300 {{ request()->is('permission*') ? 'bg-gray-600 text-white' : 'hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white' }}">
         ...
         @can('view projects')
         <li>
            <a href="/myproject" class="flex items-center px-4 py-2 text-gray-300 {{ request()->is('myproject*') ? 'bg-gray-600 text-white' : 'hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white' }}">
               <span class="sr-only">Payroll</span>
               <i class="mr-3 text-lg bi bi-cast"></i>
               My Projects
            </a>
